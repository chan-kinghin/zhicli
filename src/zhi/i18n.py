...
CHAT_SYSTEM_PROMPT = (
    ...
    "\n"
    "1. CLARIFY BEFORE ACTING: When a request is ambiguous, has multiple valid "
    "interpretations, or requires choosing between options (e.g. which column, "
    "which price tier, which format), you MUST call the ask_user tool to clarify "
    "BEFORE doing any work. Do not guess — clarification takes seconds.\n"
    "\n"
    "2. USE skill_create FOR REPEATABLE TASKS: When the user asks to create a "
    "skill, workflow, or reusable automation (e.g. '创建技能', '创建一个…技能', "
    "'create a skill'), you MUST use the skill_create tool. NEVER use shell to "
    "write ad-hoc Python scripts or YAML files manually — that is what "
    "skill_create is for.\n"
    "\n"
    "3. INCLUDE ask_user IN NEW SKILLS: When creating skills that process data "
    "with variable formats, ambiguous fields, or multiple possible "
    "interpretations (e.g. spreadsheets with multiple price columns, documents "
    "with multiple sections), you MUST include 'ask_user' in the skill's tools "
    "list so the skill can request clarification at runtime.\n"
    "\n"
    "4. NEVER write ad-hoc shell/Python scripts to do what a tool already does. "
    "Use the available tools: file_read for reading files, file_write for "
    "writing files, skill_create for creating skills.\n"
    "\n"
...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "repl.run_parse_error": "Error parsing arguments: {error}. Use quotes for paths with spaces.",
        ...
        "repl.skill_edit_todo": "Skill editing not yet supported. Edit the YAML file directly.",
        "repl.skill_delete_todo": "Skill deletion not yet supported.",
        ...
        "setup.demo_skip": "  Demo skipped.",
        "setup.demo_no_key": "  No API key provided, skipping demo.",
        "setup.demo_running": "  Testing your API key with glm-4-flash...",
        "setup.demo_success": "  API key works! Response: {response}",
        "setup.demo_error": "  Demo failed: {error}. You can still use zhi if the key is correct.",
        "setup.demo_empty": "  API returned an empty response. Key may still be valid.",
        "setup.demo_prompt_text": "Say hello in one sentence.",
    ...
    "zh": {
        ...
        "repl.run_parse_error": "\u53c2\u6570\u89e3\u6790\u9519\u8bef\uff1a{error}\u3002\u5e26\u7a7a\u683c\u7684\u8def\u5f84\u8bf7\u7528\u5f15\u53f7\u5305\u88f9\u3002",
        ...
        "repl.skill_edit_todo": "\u6280\u80fd\u7f16\u8f91\u5c1a\u672a\u652f\u6301\u3002\u8bf7\u76f4\u63a5\u7f16\u8f91 YAML \u6587\u4ef6\u3002",
        "repl.skill_delete_usage": "\u7528\u6cd5\uff1a/skill delete <\u540d\u79f0>",
        "repl.skill_delete_todo": "\u6280\u80fd\u5220\u9664\u5c1a\u672a\u652f\u6301\u3002",
        ...
        "setup.demo_skip": "  \u6f14\u793a\u5df2\u8df3\u8fc7\u3002",
        "setup.demo_no_key": "  \u672a\u63d0\u4f9b API \u5bc6\u94a5\uff0c\u8df3\u8fc7\u6f14\u793a\u3002",
        "setup.demo_running": "  \u6b63\u5728\u4f7f\u7528 glm-4-flash \u6d4b\u8bd5\u60a8\u7684 API \u5bc6\u94a5...",
        "setup.demo_success": "  API \u5bc6\u94a5\u6709\u6548\uff01\u54cd\u5e94\uff1a{response}",
        "setup.demo_error": "  \u6f14\u793a\u5931\u8d25\uff1a{error}\u3002\u5982\u679c\u5bc6\u94a5\u6b63\u786e\uff0c\u60a8\u4ecd\u53ef\u4ee5\u4f7f\u7528 zhi\u3002",
        "setup.demo_empty": "  API \u8fd4\u56de\u4e86\u7a7a\u54cd\u5e94\u3002\u5bc6\u94a5\u53ef\u80fd\u4ecd\u7136\u6709\u6548\u3002",
        "setup.demo_prompt_text": "\u7528\u4e00\u53e5\u8bdd\u6253\u4e2a\u62db\u547c\u3002",
