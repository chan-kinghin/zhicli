...
[安装 :material-download:](install.md){ .md-button .md-button--primary }
[开始使用 :material-arrow-right:](tutorials.md){ .md-button }
...
Windows 用户？[下载独立 exe :material-download:](install.md){ .md-button }  无需安装 Python。
